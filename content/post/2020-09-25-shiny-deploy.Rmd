...
이번에 Docker와 Shiny를 하면서 어려움이 많았고, 아직도 많이 있습니다. 즉, 모르는게 더 많은 상태 인데요. 한번씩 따라 하시거나 그런 기회가 있을때 궁금하거나 안되는 부분이 다음 페이스북 그룹에다가 질문 남겨 주세요. 저도 찾아가면거 공부 해보고 답변 드리도록 하겠습니다.
