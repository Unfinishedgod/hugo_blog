...
<center>
![](/post/2020-08-04-bookdown-publish_files/bookdown_1.PNG){width=95%}
![](/post/2020-08-04-bookdown-publish_files/bookdown_2.PNG){width=95%}
</center>

### 2-2. Bookdown Project 생성 화면

![](/post/2020-08-04-bookdown-publish_files/bookdown_3.PNG){width=95%}
...
![](/post/2020-08-04-bookdown-publish_files/bookdown_6.PNG){width=95%}

### 4-2. 생성시 유의사항

생성시 유의사항이 있는데 원격 레포를 생성하는데 있어서 조금이나마 초보자의 시각에서 수월하게 하기 위함이다. Initialize this repository with a README 체크박스는 절대절대 **클릭금지**

![](/post/2020-08-04-bookdown-publish_files/bookdown_7.PNG){width=95%}

### 4-3. 깃 주소 복사

생성시 나오는 화면중 하나다. 저 주소를 복사 해주자.

![](/post/2020-08-04-bookdown-publish_files/bookdown_8.PNG){width=95%}
...
![](/post/2020-08-04-bookdown-publish_files/bookdown_9.PNG){width=95%}
...
![](/post/2020-08-04-bookdown-publish_files/bookdown_10.PNG){width=95%}
...
![](/post/2020-08-04-bookdown-publish_files/bookdown_11.PNG){width=95%}
...
![](/post/2020-08-04-bookdown-publish_files/bookdown_12.PNG){width=95%}
...
![](/post/2020-08-04-bookdown-publish_files/bookdown_13.PNG){width=95%}
