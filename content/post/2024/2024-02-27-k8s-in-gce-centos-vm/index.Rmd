...
![](images/쿠버네티스설치_1.png){width=60%}

### 3-2. 

그리고 나서 우측 상단의 '머신 이미지 만들기' 버튼을 클릭해주자.

![](images/쿠버네티스설치_2.png){width=60%}
...
![](images/쿠버네티스설치_12.png){width=80%}
