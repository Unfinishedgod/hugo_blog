...
<center>
![](images/hf_up_download_4 (1).png){width=50%}
</center>
...
데이터셋을 클릭하면 다음과 같이 데이터가 성공적으로 올라간것을 확인할 수 있다. 이제 다운로드를 해보자. 그전에 이 데이터셋의 주소를 클릭하여 복사를 해주자.

<center>
![](images/hf_up_download_4 (1).png){width=70%}
</center>
...
```python
dataset = load_dataset('uiyong/gemini_result_kospi_0517')
dataset
```
```
DatasetDict({
